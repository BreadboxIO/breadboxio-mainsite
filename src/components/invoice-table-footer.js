    ...
    return (
      <div className="invoice-table__footer">
        <div className="invoice-table__data-row invoice-table__table-row">
          ...
          <InvoiceTableCell flex={2} className="text-align--right text-transform--uppercase">
            Subtotal:
          </InvoiceTableCell>
        ...
        <div className="invoice-table__data-row invoice-table__table-row">
          <InvoiceTableCell spacer flex={5} style={{ marginBottom: '-100px' }}>
            <p>
              Please make checks payable to <strong>Breadbox LLC</strong>.<br />
        ...
        <div className="invoice-table__data-row invoice-table__table-row">
          ...
          <InvoiceTableCell
            flex={2}
            className="invoice-table__footer__total-label text-align--right text-transform--uppercase"
          >
            <strong>Total To Pay:</strong>
          </InvoiceTableCell>
          <InvoiceTableCell flex={2} className="invoice-table__footer__total-value text-align--right">
            <strong>${netTotal}</strong>
          </InvoiceTableCell>
          <InvoiceTableCell flex="none" className="invoice-table__footer__total-value">
            <strong>=</strong>
          </InvoiceTableCell>
        </div>
      </div>
