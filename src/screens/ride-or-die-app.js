            ...
            <div className='app-detail'>
                ...
                <div className='app-detail-features'>
                    <div>
                        ...
                        <p>Tap the "Current Mode" button to switch into "Commute Mode." In Commute Mode, <strong>{appName}</strong> will utilize your commute times and your home/work locations to estimate "whether" the "weather" will match your riding preferences when you're leaving for and returning from work.</p>
